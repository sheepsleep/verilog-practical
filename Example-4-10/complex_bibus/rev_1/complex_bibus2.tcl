...
set_global_assignment -section_id complex_bibus -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_instance_assignment -entity complex_bibus -to clk -name GLOBAL_SIGNAL ON
set_instance_assignment -entity complex_bibus -to clk -name USE_CLOCK_SETTINGS clk_setting 
