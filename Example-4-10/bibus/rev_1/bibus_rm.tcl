set_global_assignment -name ROOT "|bibus" -remove 
set_global_assignment -name FAMILY -remove 
set_global_assignment -section_id clk_setting -name DUTY_CYCLE "50.00" -remove 
set_instance_assignment -entity bibus -to clk -name GLOBAL_SIGNAL ON -remove 
set_instance_assignment -entity bibus -to clk -name USE_CLOCK_SETTINGS clk_setting -remove 
