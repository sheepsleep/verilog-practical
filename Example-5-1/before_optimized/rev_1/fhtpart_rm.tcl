...
if {[cmp get_assignment_value "fhtpart" "" "" DEVICE] !=  ""} {
  cmp remove_assignment "fhtpart" "" "" DEVICE ""
}
if {[project get_assignment_value "fhtpart" "" "" "Clk" "GLOBAL_SIGNAL"] !=  ""} {
  project remove_assignment "fhtpart" "" "" "Clk" "GLOBAL_SIGNAL" ""
}
if {[project get_assignment_value "" "Clk_setting" "" "" "DUTY_CYCLE"] != ""} {
  project remove_assignment "" "Clk_setting" "" "" "DUTY_CYCLE" ""
}
if {[project get_assignment_value "fhtpart" "" "" "Clk" "USE_CLOCK_SETTINGS"] != ""} {
  project remove_assignment "fhtpart" "" "" "Clk" "USE_CLOCK_SETTINGS" ""
}
